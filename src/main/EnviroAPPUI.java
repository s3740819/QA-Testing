...
public class EnviroAPPUI {
	...
	static String testMessage = new String();

	static class AlerterI implements Alerter { // change private to none
	...
	static void setupSubcriber() {//changed private to none - package access
	...
	//Change form private to package access
	static void iniContextManagerWorker(String[] args) {
