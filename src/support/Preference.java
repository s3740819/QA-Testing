...
public class Preference {
	...
	public Preference(List<String> strings) {
		...
		for (String string : strings) {
			...
			String firstPart = splits[0].trim(); // trim() to eliminate only leading and trailing spaces
			...
			case "Medical Condition Type":
				...
				break;
			case "pref":
				suggestions.add(secondPart); // store a list of string preferences (examples: {when 16 suggest pool, when APO suggest cinema, etc.})
				break;
			default:
				break;
			}
